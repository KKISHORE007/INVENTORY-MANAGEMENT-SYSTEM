...
const Customers = () => {
  ...
  const initialForm = { name: '', email: '', phone: '', address: '', type: 'Retail' };
                ...
                <tr key={c._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                      c.type === 'Wholesale' ? 'bg-purple-100 text-purple-800' : 
                      c.type === 'Corporate' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                    }`}>
                      {c.type}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button onClick={() => openEditModal(c)} className="text-blue-600 hover:text-blue-900 mx-2">
